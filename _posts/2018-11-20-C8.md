...
layout: post
title: Captcha
permalink: /ctf/squarectf2018/C8
date: 2018-11-20 10:26:00 -0400
categories: ctf
---
Look [here](/assets/C8_raw.zip) for a listing of related files.
...
The problem contained a link to a page with a long arithmetic problem, and a
...
build the translation character by character. The eventual result of this was
[this](C8_raw/translate.py) script, which prompts the user to input the
challenge text, and then prompts again for every unknown symbol -- displaying
all of the translatable text up to that point for reference. Once it can
translate the entire string, it evaluates it to get the answer.
...
[a text file](C8_raw/font.txt), then attempted to decode and analyze it:
...
Which was my cue to start reading about TrueType fonts. I ended up getting most
