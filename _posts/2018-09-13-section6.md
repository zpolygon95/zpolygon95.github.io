...
```
(Look [here](/assets/section6_raw.zip) for a listing of related files)
...
Looking through each of the text files, only `./Documents/6/Pages/6.fpage` is very
interesting. Right away, at the end of most of the lines appears to be some sort
of ASCII art composed of hashes and periods. I removed all the superfluous text,
and replaced the periods with spaces.
